...
check out the UI development tools `[1] <https://github.com/yetitecnologia/ui_devtools>`__  that have been released alongside.
...
* plugins: os-acme-client 1.15 `[3] <https://github.com/yetitecnologia/plugins/pull/682>`__  (contributed by Frank Wall and Omar Khalil)
* plugins: os-freeradius 1.7.0 (contributed by Michael Muenz)
* plugins: os-haproxy 2.7 `[4] <https://github.com/yetitecnologia/plugins/pull/579>`__  (contributed by Frank Wall)
...
* ports: switch from dhcp6 to our own lightweight dhcp6c `[1] <https://github.com/yetitecnologia/dhcp6c>`__ 
...
* mvc: fix regression in model relation load order `[9] <https://github.com/yetitecnologia/core/issues/2389>`__ 
...
* plugins: os-haproxy 2.6 `[1] <https://github.com/yetitecnologia/plugins/pull/575>`__  (contributed by Frank Wall)
...
* plugins: os-haproxy 2.5 `[1] <https://github.com/yetitecnologia/plugins/pull/541>`__  with PROXY support and HAProxy 1.8 (contributed by Frank Wall)
...
* plugins: os-haproxy 2.4 `[3] <https://github.com/yetitecnologia/plugins/pull/483>`__  (contributed by Frank Wall)
