...
* plugins: os-freeradius 1.9.27 `[3] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/net/freeradius/pkg-descr>`__ 
* plugins: os-haproxy 4.4 `[4] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/net/haproxy/pkg-descr>`__ 
* plugins: os-mdns-repeater 1.2 `[5] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/net/mdns-repeater/pkg-descr>`__ 
* plugins: os-squid 1.1 `[6] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/www/squid/pkg-descr>`__ 
* plugins: os-tailscale 1.1 `[7] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/security/tailscale/pkg-descr>`__ 
...
* plugins: os-caddy 1.7.6 `[2] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/www/caddy/pkg-descr>`__ 
* plugins: os-ddclient 1.26 `[3] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/dns/ddclient/pkg-descr>`__ 
* plugins: os-nut 1.9 `[4] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/sysutils/nut/pkg-descr>`__ 
* plugins: os-qemu-guest-agent 1.3 `[5] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/emulators/qemu-guest-agent/pkg-descr>`__ 
* plugins: os-tailscale 1.0 (contributed by Sheridan Computers)
* plugins: os-telegraf 1.12.12 `[6] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/net-mgmt/telegraf/pkg-descr>`__ 
...
* plugins: os-caddy 1.7.5 `[1] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/www/caddy/pkg-descr>`__ 
* plugins: os-debug 1.7 `[2] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/devel/debug/pkg-descr>`__ 
...
* plugins: os-wazuh-agent 1.2 `[1] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/security/wazuh-agent/pkg-descr>`__ 
...
* plugins: os-caddy 1.7.3 `[1] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/www/caddy/pkg-descr>`__ 
* plugins: os-ddclient 1.25 `[2] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/dns/ddclient/pkg-descr>`__ 
* plugins: os-freeradius 1.9.26 `[3] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/net/freeradius/pkg-descr>`__ 
* plugins: os-frr 1.42 `[4] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/net/frr/pkg-descr>`__ 
* plugins: os-lldpd 1.2 `[5] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/net-mgmt/lldpd/pkg-descr>`__ 
* plugins: os-net-snmp 1.6 `[6] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/net-mgmt/net-snmp/pkg-descr>`__ 
* plugins: os-upnp 1.7 `[7] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/net/upnp/pkg-descr>`__ 
* plugins: os-wazuh-agent 1.1 `[8] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/security/wazuh-agent/pkg-descr>`__ 
...
* plugins: os-caddy 1.7.2 `[3] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/www/caddy/pkg-descr>`__ 
* plugins: os-frr 1.41 `[4] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/net/frr/pkg-descr>`__ 
...
* plugins: os-caddy 1.7.1 `[1] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/www/caddy/pkg-descr>`__ 
...
* plugins: os-caddy 1.7.0 `[1] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/www/caddy/pkg-descr>`__ 
...
* plugins: os-ddclient 1.24 `[1] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/dns/ddclient/pkg-descr>`__ 
...
* plugins: os-upnp 1.6 `[2] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/net/upnp/pkg-descr>`__ 
...
* plugins: os-caddy 1.6.3 `[1] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/www/caddy/pkg-descr>`__ 
* plugins: os-cpu-microcode-amd 1.0
* plugins: os-cpu-microcode-intel 1.0
* plugins: os-freeradius 1.9.25 `[2] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/net/freeradius/pkg-descr>`__ 
...
* plugins: os-acme-client 4.5 `[1] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/security/acme-client/pkg-descr>`__ 
* plugins: os-apcupsd 1.2 `[2] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/sysutils/apcupsd/pkg-descr>`__ 
* plugins: os-caddy 1.6.2 `[3] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/www/caddy/pkg-descr>`__ 
* plugins: os-ddclient 1.23 `[4] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/dns/ddclient/pkg-descr>`__ 
...
* ports: dhcrelay 0.6 `[9] <https://github.com/yetitecnologia/dhcrelay/issues/2>`__ 
...
* plugins: os-acme-client 4.4 `[2] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/security/acme-client/pkg-descr>`__ 
* plugins: os-caddy 1.6.1 `[3] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/www/caddy/pkg-descr>`__ 
* plugins: os-dec-hw 1.1 replaces the dashboard widget
* plugins: os-etpro-telemetry 1.7 replaces dashboard widget
* plugins: os-freeradius 1.29.4 `[4] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/net/freeradius/pkg-descr>`__ 
* plugins: os-nginx 1.34 `[5] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/www/nginx/pkg-descr>`__ 
...
* mvc: hook default index action in API handler
* src: assorted backports from FreeBSD stable/14 branch
* plugins: os-caddy 1.6.1 `[2] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/www/caddy/pkg-descr>`__ 
* plugins: os-dec-hw 1.1 replaces the dashboard widget
* plugins: os-nginx 1.34 `[3] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/www/nginx/pkg-descr>`__ 
* plugins: os-theme-cicada 1.37 fixes dropdown element style (contributed by Team Rebellion)
* plugins: os-theme-vicuna 1.47 fixes dropdown element style (contributed by Team Rebellion)
...
* mvc: improve searchRecordsetBase() filtering capabilities
* mvc: improve container field cloning
* plugins: os-acme-client 4.4 `[1] <https://github.com/yetitecnologia/plugins/blob/stable/24.7/security/acme-client/pkg-descr>`__ 
* plugins: os-etpro-telemetry 1.7 replaces dashboard widget
...
https://yeti.tec.br/yetisense/releases/24.7/
