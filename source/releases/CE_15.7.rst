...
kernel and base upgrade gained better signature support `[1] <https://github.com/yetitecnologia/update#opnsense-sign--opnsense-verify>`__  that ties
...
* src: merge stf(4) driver modifications from pfSense `[2] <https://github.com/yetitecnologia/src/commit/19ba0fbfd15ea8ff24ce172dee30e1>`__ 
...
* ports: opnsense-bootstrap, the infamous installer that works on stock FreeBSD `[8] <https://github.com/yetitecnologia/update/commit/e3f63ecdb1149a8cc30e3>`__ 
...
* interfaces: fix faulty GUI caching issues `[3] <https://github.com/yetitecnologia/core/issues/451>`__ 
