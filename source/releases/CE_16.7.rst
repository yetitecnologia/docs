...
* ports: openvpn `[1] <https://github.com/yetitecnologia/core/issues/1314>`__  (reverted topology subnet fix)
...
* ports: pkg 1.9.3 upstream fetch patch `[1] <https://github.com/yetitecnologia/ports/commit/3249295dd>`__ 
...
* src: revert extended descriptor format for em(4) `[2] <https://github.com/yetitecnologia/src/commit/b0f7ff3>`__ 
