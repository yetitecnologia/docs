...
* plugins: acme-client 1.13 `[1] <https://github.com/yetitecnologia/plugins/pull/482>`__  (contributed by Frank Wall)
...
* system: fix XSS with crafted certificates in certificate manager `[1] <https://github.com/yetitecnologia/core/issues/1964>`__ 
...
* plugins: os-acme-client 1.12 `[2] <https://github.com/yetitecnologia/plugins/pull/336>`__  (contributed by Frank Wall)
...
* plugins: os-haproxy 2.0 `[3] <https://github.com/yetitecnologia/plugins/pull/330>`__  (contributed by Frank Wall)
...
* plugins: os-haproxy 2.1 fixes HSTS usage `[9] <https://github.com/yetitecnologia/plugins/pull/419>`__  (contributed by Frank Wall)

Another hotfix release was issued as 17.7.9_9:

* system: fix a PHP 7.1 runtime error in certificate generation
* plugins: os-haproxy 2.2 fixes rules parameters `[10] <https://github.com/yetitecnologia/plugins/pull/420>`__  (contributed by Frank Wall)
...
* plugins: os-acme-client 1.11 `[1] <https://github.com/yetitecnologia/plugins/pull/290>`__  (contributed by Frank Wall)
...
* plugins: os-acme-client 1.10 `[1] <https://github.com/yetitecnologia/plugins/pull/254>`__  (contributed by Frank Wall)
...
* ipsec: portable NAT before IPsec support `[1] <https://github.com/yetitecnologia/core/issues/440>`__ 
...
* Users from 17.7-RC2 may have trouble upgrading via the GUI `[4] <https://github.com/yetitecnologia/core/commit/246513c>`__ .  Run "opnsense-patch 246513c" from the command line to correct this problem.
* A regression in floating rules in 17.7 does not honour the non-quick setting `[5] <https://github.com/yetitecnologia/core/commit/f25d8b>`__ .  Run "opnsense-patch f25d8b" from the command line to correct this problem.
...
* WLAN devices cannot be created.  A patch exists `[2] <https://github.com/yetitecnologia/core/commit/5cb149d>`__  to remedy this problem.
