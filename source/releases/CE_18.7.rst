...
* plugins: os-bind 1.4 `[1] <https://github.com/yetitecnologia/plugins/blob/master/dns/bind/pkg-descr>`__  (contributed by Michael Muenz)
...
* plugins: os-haproxy 2.13 `[2] <https://github.com/yetitecnologia/plugins/pull/1090>`__  (contributed by Frank Wall)
...
* plugins: os-postfix 1.8 `[3] <https://github.com/yetitecnologia/plugins/blob/master/mail/postfix/pkg-descr>`__  (contributed by Michael Muenz)
...
* plugins: os-nginx 1.5 with lots of new features `[1] <https://github.com/yetitecnologia/plugins/blob/master/www/nginx/pkg-descr>`__  (contributed by Fabian Franz, Carlos Cesario, Julio Cesar Camargo, fzoske)
...
* plugins: os-haproxy 2.10 `[1] <https://github.com/yetitecnologia/plugins/pull/960>`__  `[2] <https://github.com/yetitecnologia/plugins/pull/970>`__  `[3] <https://github.com/yetitecnologia/plugins/pull/1003>`__  (contributed by Frank Wall)
...
* plugins: os-zabbix-agent 1.4 `[4] <https://github.com/yetitecnologia/plugins/pull/998>`__  (contributed by Frank Wall)
...
* plugins: os-nginx 1.2 `[1] <https://github.com/yetitecnologia/plugins/commit/6776a5a17>`__  (contributed by Fabian Franz)
...
* plugins: os-haproxy 2.8 `[1] <https://github.com/yetitecnologia/plugins/pull/772>`__  (contributed by Frank Wall)
