...
* plugins: os-bind 1.32 `[1] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/dns/bind/pkg-descr>`__ 
* plugins: os-caddy 1.6.0 `[2] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/www/caddy/pkg-descr>`__ 
* plugins: os-ddclient 1.22 `[3] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/dns/ddclient/pkg-descr>`__ 
* plugins: os-nginx 1.33 `[4] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/www/nginx/pkg-descr>`__ 
* plugins: os-theme-cicada 1.36 (contributed by Team Rebellion)
* plugins: os-theme-vicuna 1.46 (contributed by Team Rebellion)
* plugins: os-zabbix-agent 1.14 `[5] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/net-mgmt/zabbix-agent/pkg-descr>`__ 
* plugins: os-zabbix-proxy 1.11 `[6] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/net-mgmt/zabbix-proxy/pkg-descr>`__ 
...
* plugins: os-caddy 1.5.7 `[1] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/www/caddy/pkg-descr>`__ 
...
* plugins: os-caddy 1.5.6 `[1] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/www/caddy/pkg-descr>`__ 
...
* plugins: os-acme-client 4.3 `[1] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/security/acme-client/pkg-descr>`__ 
* plugins: os-caddy 1.5.5 `[2] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/www/caddy/pkg-descr>`__ 
* plugins: os-crowdsec 1.0.8 `[3] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/security/crowdsec/pkg-descr>`__ 
* plugins: os-freeradius 1.9.23 `[4] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/net/freeradius/pkg-descr>`__ 
* plugins: os-frr 1.40 `[5] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/net/frr/pkg-descr>`__ 
...
* plugins: os-telegraf 1.12.11 `[6] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/net-mgmt/telegraf/pkg-descr>`__ 
* ports: libpfctl 0.11
* ports: libucl 0.9.2
...
* plugins: os-acme-client 4.2 `[2] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/security/acme-client/pkg-descr>`__ 
* plugins: os-caddy 1.5.4 `[3] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/www/caddy/pkg-descr>`__ 
* plugins: os-zabbix-proxy 1.10 `[4] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/net-mgmt/zabbix-proxy/pkg-descr>`__ 
* ports: dhcrelay 0.4 `[5] <https://github.com/yetitecnologia/dhcrelay>`__ 
...
* plugins: os-bind 1.21 `[1] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/dns/bind/pkg-descr>`__ 
* plugins: os-caddy 1.5.3 `[2] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/www/caddy/pkg-descr>`__ 
...
* plugins: os-bind 1.30 `[1] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/dns/bind/pkg-descr>`__ 
* plugins: os-caddy 1.5.2 `[2] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/www/caddy/pkg-descr>`__  (contributed by Monviech)
...
* plugins: os-acme-client 4.1 `[5] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/security/acme-client/pkg-descr>`__ 
* plugins: os-ddclient 1.21 `[6] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/dns/ddclient/pkg-descr>`__ 
* plugins: os-dnscrypt-proxy 1.15 `[7] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/dns/dnscrypt-proxy/pkg-descr>`__ 
...
* plugins: os-frr 1.39 `[1] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/net/frr/pkg-descr>`__ 
* plugins: os-haproxy 4.3 `[2] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/net/haproxy/pkg-descr>`__ 
* plugins: os-ntopng 1.3 `[3] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/net/ntopng/pkg-descr>`__ 
...
* plugins: os-acme-client 4.0 `[2] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/security/acme-client/pkg-descr>`__ 
* plugins: os-api-backup was discontinued due to overlapping functionality in core
* plugins: os-firewall moved to core
* plugins: os-haproxy 4.2 `[3] <https://github.com/yetitecnologia/plugins/blob/stable/24.1/net/haproxy/pkg-descr>`__ 
