...
* plugins: os-haproxy 2.20 `[1] <https://github.com/yetitecnologia/plugins/pull/1646>`__ 
...
* plugins: os-vnstat 1.2 `[3] <https://github.com/yetitecnologia/plugins/blob/master/net/vnstat/pkg-descr>`__ 
* plugins: zabbix4-proxy 1.2 `[4] <https://github.com/yetitecnologia/plugins/blob/master/net-mgmt/zabbix4-proxy/pkg-descr>`__ 
...
* plugins: os-acme-client 1.29 `[2] <https://github.com/yetitecnologia/plugins/pull/1638>`__ 
* plugins: os-bind 1.12 `[3] <https://github.com/yetitecnologia/plugins/blob/master/dns/bind/pkg-descr>`__ 
* plugins: os-dyndns must use dyndns_failover_interface() to translate gateway group
* plugins: os-frr 1.14 `[4] <https://github.com/yetitecnologia/plugins/blob/master/net/frr/pkg-descr>`__ 
* plugins: os-maltrail 1.3 `[5] <https://github.com/yetitecnologia/plugins/blob/master/security/maltrail/pkg-descr>`__ 
* plugins: os-nginx 1.17 `[6] <https://github.com/yetitecnologia/plugins/blob/master/www/nginx/pkg-descr>`__ 
...
* plugins: os-zabbix4-proxy 1.1 `[7] <https://github.com/yetitecnologia/plugins/blob/master/net-mgmt/zabbix4-proxy/pkg-descr>`__ 
...
* plugins: os-bind 1.11 `[1] <https://github.com/yetitecnologia/plugins/blob/master/dns/bind/pkg-descr>`__ 
* plugins: os-dyndns 1.18 adds Linode support (contributed by Andrew Gunnerson)
* plugins: os-freeradius 1.9.5 `[2] <https://github.com/yetitecnologia/plugins/blob/master/net/freeradius/pkg-descr>`__ 
* plugins: os-frr 1.13 `[3] <https://github.com/yetitecnologia/plugins/blob/master/net/frr/pkg-descr>`__ 
* plugins: os-ftp-proxy style updates only
* plugins: os-postfix 1.13 `[4] <https://github.com/yetitecnologia/plugins/blob/master/mail/postfix/pkg-descr>`__ 
* plugins: os-rspamd 1.9 `[5] <https://github.com/yetitecnologia/plugins/blob/master/mail/rspamd/pkg-descr>`__ 
...
* mvc: fix forceReload()
* plugins: os-acme-client 1.28 `[1] <https://github.com/yetitecnologia/plugins/pull/1565>`__ 
* plugins: os-bind 1.10 `[2] <https://github.com/yetitecnologia/plugins/blob/master/dns/bind/pkg-descr>`__ 
* plugins: os-nginx 1.16 `[3] <https://github.com/yetitecnologia/plugins/blob/master/www/nginx/pkg-descr>`__ 
* plugins: os-nut 1.6 `[4] <https://github.com/yetitecnologia/plugins/blob/master/sysutils/nut/pkg-descr>`__ 
* plugins: os-postfix 1.12 `[5] <https://github.com/yetitecnologia/plugins/blob/master/mail/postfix/pkg-descr>`__ 
...
* plugins: os-acme-client 1.27 `[1] <https://github.com/yetitecnologia/plugins/pull/1536>`__ 
* plugins: os-bind 1.9 `[2] <https://github.com/yetitecnologia/plugins/blob/stable/20.1/dns/bind/pkg-descr>`__ 
* plugins: os-nginx 1.15 `[3] <https://github.com/yetitecnologia/plugins/blob/stable/20.1/www/nginx/pkg-descr>`__ 
...
* plugins: os-acme-client 1.26 `[1] <https://github.com/yetitecnologia/plugins/pull/1499>`__ 
...
* plugins: os-freeradius 1.9.4 `[2] <https://github.com/yetitecnologia/plugins/blob/master/net/freeradius/pkg-descr>`__ 
* plugins: os-frr 1.12 `[3] <https://github.com/yetitecnologia/plugins/blob/master/net/frr/pkg-descr>`__ 
* plugins: os-haproxy 2.19 `[4] <https://github.com/yetitecnologia/plugins/pull/1498>`__ 
* plugins: os-mailtrail 1.2 `[5] <https://github.com/yetitecnologia/plugins/blob/master/security/maltrail/pkg-descr>`__ 
* plugins: os-postfix 1.11 `[6] <https://github.com/yetitecnologia/plugins/blob/master/mail/postfix/pkg-descr>`__ 
* plugins: os-rspamd 1.8 `[7] <https://github.com/yetitecnologia/plugins/blob/master/mail/rspamd/pkg-descr>`__ 
* plugins: os-sunnyvalley LibreSSL support (contributed by Sunny Valley Networks)
* plugins: os-telegraf 1.7.6 `[8] <https://github.com/yetitecnologia/plugins/blob/master/net-mgmt/telegraf/pkg-descr>`__ 
...
* plugins: os-bind 1.8 `[2] <https://github.com/yetitecnologia/plugins/blob/master/dns/bind/pkg-descr>`__  (contributed by ErikJStaab)
* plugins: os-dnscrypt-proxy 1.6 `[3] <https://github.com/yetitecnologia/plugins/blob/master/dns/dnscrypt-proxy/pkg-descr>`__  (contributed by ErikJStaab)
...
* plugins: os-acme-client 1.25 `[1] <https://github.com/yetitecnologia/plugins/pull/1452>`__ 
* plugins: os-bind 1.7 `[2] <https://github.com/yetitecnologia/plugins/blob/master/dns/bind/pkg-descr>`__ 
* plugins: os-dyndns 1.17 removes OpenDNS and fixes DyNS
* plugins: os-haproxy 2.18 `[3] <https://github.com/yetitecnologia/plugins/pull/1453>`__ 
* plugins: os-maltrail 1.1 `[4] <https://github.com/yetitecnologia/plugins/blob/master/security/maltrail/pkg-descr>`__ 
* plugins: os-nginx log rotation fix (contributed by Fabian Franz)
* plugins: os-postfix 1.10 `[5] <https://github.com/yetitecnologia/plugins/blob/master/mail/postfix/pkg-descr>`__ 
...
* plugins: os-wireguard 1.1 `[6] <https://github.com/yetitecnologia/plugins/blob/master/net/wireguard/pkg-descr>`__ 
...
* plugins: os-acme-client 1.24 `[1] <https://github.com/yetitecnologia/plugins/pull/1399>`__ 
* plugins: os-bind 1.6 `[2] <https://github.com/yetitecnologia/plugins/blob/master/dns/bind/pkg-descr>`__ 
* plugins: os-dnscrypt-proxy 1.5 `[3] <https://github.com/yetitecnologia/plugins/blob/master/dns/dnscrypt-proxy/pkg-descr>`__ 
* plugins: os-frr now restricts characters BGP prefix-list and route-maps `[4] <https://github.com/yetitecnologia/plugins/blob/master/net/frr/pkg-descr>`__ 
* plugins: os-google-cloud-sdk 1.0 `[5] <https://github.com/yetitecnologia/plugins/pull/1392>`__ 
...
* plugins: os-haproxy 2.17 `[2] <https://github.com/yetitecnologia/plugins/pull/1347>`__  `[3] <https://github.com/yetitecnologia/plugins/pull/1408>`__ 
