...
* plugins: Let's Encrypt 1.4 `[1] <https://github.com/yetitecnologia/plugins/pull/91>`__  `[2] <https://github.com/yetitecnologia/plugins/pull/103>`__  (contributed by Felix Kling
  and Frank Wall)
* plugins: HAproxy 1.13 `[3] <https://github.com/yetitecnologia/plugins/pull/94>`__  (contributed by Frank Wall)
...
* plugins: Let's Encrypt version 1.2 (contributed by Frank Wall) `[3] <https://github.com/yetitecnologia/plugins/pull/76>`__ 
...
* mvc: soft-fail on missing classes in ModelRelationField (contributed
  by Frank Wall)
* plugins: os-acme-client 1.1 `[1] <https://github.com/yetitecnologia/plugins/pull/71>`__  (contributed by Frank Wall)
* plugins: os-haproxy 1.12 `[2] <https://github.com/yetitecnologia/plugins/pull/72>`__  (contributed by Frank Wall)
...
* Let's Encrypt Plugin `[1] <https://github.com/yetitecnologia/plugins/pull/66>`__  (contributed by Frank Wall)
* Tinc VPN Plugin
...
* GitHub: https://github.com/yetitecnologia
