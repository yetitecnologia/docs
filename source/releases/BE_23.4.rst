...
* ports: strongswan upstream fix for VICI stalls `[18] <https://github.com/yetitecnologia/core/issues/6308>`__ 
...
* plugins: os-bind 1.26 `[3] <https://github.com/yetitecnologia/plugins/blob/stable/23.1/dns/bind/pkg-descr>`__ 
* plugins: os-crowdsec 1.0.5 `[4] <https://github.com/yetitecnologia/plugins/blob/stable/23.1/security/crowdsec/pkg-descr>`__ 
* plugins: os-ddclient 1.13 `[5] <https://github.com/yetitecnologia/plugins/blob/stable/23.1/dns/ddclient/pkg-descr>`__ 
* plugins: os-dnscrypt-proxy 1.13 `[6] <https://github.com/yetitecnologia/plugins/blob/stable/23.1/dns/dnscrypt-proxy/pkg-descr>`__ 
* plugins: os-nginx 1.32 `[7] <https://github.com/yetitecnologia/plugins/blob/stable/23.1/www/nginx/pkg-descr>`__ 
...
* src: bridge: add support for emulated netmap mode `[8] <https://github.com/yetitecnologia/src/commit/eebd4b140f>`__ 
...
* src: netmap: fix queue stalls with generic interfaces `[9] <https://github.com/yetitecnologia/src/commit/cc92d78fa5>`__ 
...
* plugins: os-acme-client 3.16 `[3] <https://github.com/yetitecnologia/plugins/blob/stable/23.1/security/acme-client/pkg-descr>`__ 
* plugins: os-api-backup 1.1 `[4] <https://github.com/yetitecnologia/plugins/blob/stable/23.1/sysutils/api-backup/pkg-descr>`__ 
* plugins: os-bind 1.25 `[5] <https://github.com/yetitecnologia/plugins/blob/stable/23.1/dns/bind/pkg-descr>`__ 
* plugins: os-crowdsec 1.0.2 `[6] <https://github.com/yetitecnologia/plugins/blob/stable/23.1/security/crowdsec/pkg-descr>`__ 
* plugins: os-ddclient 1.11 `[7] <https://github.com/yetitecnologia/plugins/blob/stable/23.1/dns/ddclient/pkg-descr>`__ 
* plugins: os-freeradius 1.9.22 `[8] <https://github.com/yetitecnologia/plugins/blob/stable/23.1/net/freeradius/pkg-descr>`__ 
* plugins: os-frr 1.33 `[9] <https://github.com/yetitecnologia/plugins/blob/stable/23.1/net/frr/pkg-descr>`__ 
* plugins: os-haproxy 4.1 `[10] <https://github.com/yetitecnologia/plugins/blob/stable/23.1/net/haproxy/pkg-descr>`__ 
* plugins: os-openconnect 1.4.4 `[11] <https://github.com/yetitecnologia/plugins/blob/stable/23.1/security/openconnect/pkg-descr>`__ 
* plugins: os-puppet-agent 1.1 `[12] <https://github.com/yetitecnologia/plugins/blob/stable/23.1/sysutils/puppet-agent/pkg-descr>`__ 
* plugins: os-qemu-guest-agent 1.2 `[13] <https://github.com/yetitecnologia/plugins/blob/stable/23.1/emulators/qemu-guest-agent/pkg-descr>`__ 
* plugins: os-rfc2136 1.8 `[14] <https://github.com/yetitecnologia/plugins/blob/stable/23.1/dns/rfc2136/pkg-descr>`__ 
* plugins: os-sslh 1.0 `[15] <https://github.com/yetitecnologia/plugins/blob/stable/23.1/net/sslh/pkg-descr>`__  (contributed by agh1467)
...
* plugins: os-upnp 1.5 `[16] <https://github.com/yetitecnologia/plugins/blob/stable/23.1/net/upnp/pkg-descr>`__ 
